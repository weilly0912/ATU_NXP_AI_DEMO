...
def main():
  ...
  # learn style from encoder
  style_bottleneck_style23   = StyleEncoder("magenta_arbitrary-image-stylization-v1-256_int8_prediction_1.tflite", "style23.jpg")
  style_bottleneck_VanGogh   = StyleEncoder("magenta_arbitrary-image-stylization-v1-256_int8_prediction_1.tflite", "VanGogh_Star.jpg")
  style_bottleneck_sketch    = StyleEncoder("magenta_arbitrary-image-stylization-v1-256_int8_prediction_1.tflite", "sketch.jpg")
  style_bottleneck_waterpaint= StyleEncoder("magenta_arbitrary-image-stylization-v1-256_int8_prediction_1.tflite", "waterpaint.jpg")
  style_bottleneck_colpencil = StyleEncoder("magenta_arbitrary-image-stylization-v1-256_int8_prediction_1.tflite", "towers_1916_sq.jpg")

  style_bottleneck = style_bottleneck_waterpaint 
